...
''')
    out_file.write('   1000011	%f		# ~e_L\n' % m_slep)
    out_file.write('   2000011     1.44102799E+05   # ~e_R\n')
    out_file.write('   1000012	%f		# ~nu_eL\n' % m_slep)
    out_file.write('   1000013	%f		# ~mu_L\n' % m_slep)
    out_file.write('   2000013     1.44102799E+05   # ~mu_R\n')
    out_file.write('   1000014	%f		# ~nu_muL\n' % m_slep)
    out_file.write('   1000015	%f		# ~tau_1\n' % m_slep)
    out_file.write('   2000015     2.06867805E+05   # ~tau_2\n')
    out_file.write('   1000016	%f		# ~nu_tauL\n' % m_slep)
    out_file.write('   1000021     6.07713704E+05   # ~g\n')
    out_file.write('   1000022	%f   	# ~chi_10\n' % m_n1)
    out_file.write('   1000023	%f		# ~chi_20\n' % m_c1n2)
    out_file.write('   1000025     3.63756027E+05   # ~chi_30\n')
    out_file.write('   1000035     3.81729382E+05   # ~chi_40\n')
    out_file.write('   1000024	%f		# ~chi_1+\n' % m_c1n2)
    out_file.write('   1000037     3.79939320E+05   # ~chi_2+\n')
    out_file.write(''' #
...
#          BR         NDA      ID1           ID2        ID3
     0.0   3     1000023         -11        12   # BR(~chi_1+ -> ~chi_20  e+  nu_e)
     0.0   3     1000023         -13        14   # BR(~chi_1+ -> ~chi_20  mu+  nu_mu)
     0.0   3     1000023         -15        16   # BR(~chi_1+ -> ~chi_20  tau+  nu_tau)
     0.0    3     1000023          2         -1   # BR(~chi_1+ -> ~chi_20  u dbar)
     0.0    3     1000023          4         -3   # BR(~chi_1+ -> ~chi_20  c sbar)
     0.0   3     1000022         -11        12   # BR(~chi_1+ -> ~chi_10  e+  nu_e)
     0.0   3     1000022         -13        14   # BR(~chi_1+ -> ~chi_10  mu+  nu_mu)
     0.0   3     1000022         -15        16   # BR(~chi_1+ -> ~chi_10  tau+  nu_tau)
     0.0    3     1000022          2         -1   # BR(~chi_1+ -> ~chi_10  u  dbar)
     0.0    3     1000022          4         -3   # BR(~chi_1+ -> ~chi_10  c  sbar)
     0.0    2     1000022         24              #BR(~chi_1+ -> ~chi_10  W+)
     0.166666666667     2     1000012       -11   # BR(~chi_1+ -> ~nu_eL  e+  )
     0.166666666667     2     1000014       -13   # BR(~chi_1+ -> ~nu_muL  mu+ )
     0.166666666667     2     1000016       -15   # BR(~chi_1+ -> ~nu_tau1 tau+)
     0.166666666667     2    -1000011        12   # BR(~chi_1+ -> ~e_L+    nu_e)
     0.00000000E+00    2    -2000011        12   # BR(~chi_1+ -> ~e_R+    nu_e)
     0.166666666667     2    -1000013        14   # BR(~chi_1+ -> ~mu_L+   nu_mu)
     0.00000000E+00    2    -2000013        14   # BR(~chi_1+ -> ~mu_R+   nu_mu)
     0.166666666667     2    -1000015        16   # BR(~chi_1+ -> ~tau_1+  nu_tau)
...
#          BR         NDA      ID1       ID2
     0.0    2     1000022        23   # BR(~chi_20 -> ~chi_10   Z )
     0.0    2     1000024        -24   # BR(~chi_20 -> ~chi_1+ W- )
     0.0    2     -1000024       24   # BR(~chi_20 -> ~chi_1- W+ )

     0.0833333333333     2     1000011       -11   # BR(~chi_20 -> ~e_L-     e+)
     0.0833333333333     2    -1000011        11   # BR(~chi_20 -> ~e_L+     e-)
     0.00000000E+00    2     2000011       -11   # BR(~chi_20 -> ~e_R-     e+)
     0.00000000E+00    2    -2000011        11   # BR(~chi_20 -> ~e_R+     e-)
     0.0833333333333     2     1000013       -13   # BR(~chi_20 -> ~mu_L-    mu+)
     0.0833333333333     2    -1000013        13   # BR(~chi_20 -> ~mu_L+    mu-)
     0.00000000E+00     2     2000013       -13   # BR(~chi_20 -> ~mu_R-    mu+)
     0.00000000E+00     2    -2000013        13   # BR(~chi_20 -> ~mu_R+    mu-)
     0.0833333333333     2     1000015       -15   # BR(~chi_20 -> ~tau_1-   tau+)
     0.0833333333333     2    -1000015        15   # BR(~chi_20 -> ~tau_1+   tau-)
     0.00000000E+00     2     2000015       -15   # BR(~chi_20 -> ~tau_2-   tau+)
     0.00000000E+00     2    -2000015        15   # BR(~chi_20 -> ~tau_2+   tau-)
     0.0833333333333     2     1000012       -12   # BR(~chi_20 -> nu_eL  ~nu_e)
     0.0833333333333     2     -1000012       12   # BR(~chi_20 -> ~nu_eL  nu_e)
     0.0833333333333     2     1000014       -14   # BR(~chi_20 -> nu_muL  ~nu_mu)
     0.0833333333333     2     -1000014       14   # BR(~chi_20 -> ~nu_muL  nu_mu)
     0.0833333333333     2     1000016       -16   # BR(~chi_20 -> nu_tauL  ~nu_tau)
     0.0833333333333     2     -1000016       16   # BR(~chi_20 -> ~nu_tauL  nu_tau)
#
#         PDG            Width
